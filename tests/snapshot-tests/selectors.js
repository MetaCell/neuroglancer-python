...
export const SIDE_PANEL = ".neuroglancer-side-panel"
export const SIDE_PANEL_TAB = '.neuroglancer-tab-label'
export const RENDERING_TAB_CONTROLS = '.neuroglancer-layer-control-control'
export const IMAGE_CANVAS = '.neuroglancer-layer-group-viewer'
export const RENDERING_TAB_DROPDOWNS = 'select.neuroglancer-layer-control-control'
...
export const COLORMAP_COLOR_WIDGET = '#neuroglancer-tf-color-widget'
export const COLORMAP_KNEES = '.neuroglancer-transfer-function-panel'
